...
//// - Writing to sockets or applying backpressure (handled by `sad/streams/*`).
//// - Deciding when an interaction starts/ends (core/bridge responsibility).
////
//// Relationships:
//// - Consumed by `sad/bridge/interaction` for native streaming output.
//// - Uses `sad/sse` for framing.
