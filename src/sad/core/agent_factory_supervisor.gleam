...
//// - Provide the template used to start `sad/core/agent` instances.
////
//// Non-responsibilities:
//// - Coordinating registry or profile state (handled by `sad/core/agent_manager`).
//// - Performing provisioning or IO.
////
//// Relationships:
//// - Started under `sad/core/root_supervisor`.
//// - Used by `sad/core/agent_manager` via `factory_supervisor.get_by_name`.
...
fn agent_init_timeout_ms(cfg: types_config.SadConfig) -> Int {
