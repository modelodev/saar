...
//// - Building ProblemDetails responses (see `sad/gateway/problem`).
//// - Managing sessions, multiple keys, or OAuth.
////
//// Relationships:
//// - Used by `sad/gateway/http_server` request handlers.
//// - Uses `sad/types/core.SecretValue` as the configured API key.
