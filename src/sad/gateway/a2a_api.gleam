...
//// - Authentication (enforced by `sad/gateway/http_server`).
//// - Agent provisioning and lifecycle management.
////
//// Relationships:
//// - Uses `sad/adapters/a2a` for decoding/encoding.
//// - Resolves `instance_id -> AgentRef` via `sad/gateway/lookup_http`.
