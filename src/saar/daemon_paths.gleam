...
////
//// Responsibilities:
//// - Resolve `SAAR_PID_FILE` and `SAAR_LOG_FILE` with sane defaults.
...
////
//// Relationships:
//// - Consumed by CLI/server bootstrap code and `saar/daemon_control`.
...
pub fn resolve_pidfile_path() -> String {
  resolve_path("SAAR_PID_FILE", "~/.saar/saar.pid")
}

pub fn resolve_logfile_path() -> String {
  resolve_path("SAAR_LOG_FILE", "~/.saar/saar.log")
}
