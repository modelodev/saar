...
////
//// Relationships:
//// - Used by `saar/decoders` for parameter decoding.
//// - Used by `saar/params` for runtime resolution checks.
//// - Used by `saar/profiles_sources` to validate loaded profiles.
