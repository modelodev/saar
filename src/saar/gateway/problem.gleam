...
////
//// Relationships:
//// - Used by `saar/gateway/http_server` and endpoint handlers.
...
///
/// A2A v0 uses RFC7807 without SAAR-specific `extensions`.
...
pub fn bad_request_with_code(
  ...
  build(
    status: 400,
    title: "Bad Request",
    type_url: "https://saar/errors/invalid-request",
    detail: detail,
    instance: instance,
...
fn infra_error(
  ...
  build(
    status: status,
    title: http_title(status),
    type_url: "https://saar/errors/infra-error",
    detail: detail,
    instance: instance,
...
fn error_kind_mapping(kind: types_enums.ErrorKind) -> #(Int, String, String) {
  case kind {
    types_enums.BadRequest -> #(
      400,
      "Bad Request",
      "https://saar/errors/invalid-request",
    )
