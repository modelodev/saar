...
////
//// Mission: define the typed results and errors returned by SAAR interactions,
...
////
//// Relationships:
//// - Uses ids and secrets from `saar/types/core`.
//// - Uses error enums from `saar/types/enums`.
...
/// Canonical error type used across SAAR.
///
/// This is currently an alias of `InteractionError`.
pub type SaarError =
  InteractionError

/// Builds a canonical SAAR error.
///
