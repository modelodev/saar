...
////
//// Mission: build on `saar/port_pool` to perform host-level availability checks
...
//// - Provide convenience wrappers that use `saar/net/port_check`.
////
//// Non-responsibilities:
//// - Maintaining pool state; `saar/port_pool` owns reservations.
//// - Implementing TCP checks; delegated to `saar/net/port_check`.
////
//// Relationships:
//// - Depends on `saar/port_pool` for state + error types.
//// - Uses `saar/net/port_check` for host availability checks.
...
///
/// This uses `saar/net/port_check`, so supported hosts are: `localhost`, `0.0.0.0`,
