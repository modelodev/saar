...
////
//// Relationships:
//// - Used by core actors under `saar/core/*`.
//// - References domain primitives from `saar/types/*` and the public agent handle
////   from `saar/core/agent`.
...
import saar/types/config.{type SaarConfig}
import saar/types/core as types_core
import saar/types/profile.{type Profile}
