////
//// Mission: define process names used by the SAAR core OTP tree.
////
//// Responsibilities:
...
///
/// This is intended for tests that start multiple SAAR instances in the same BEAM
...
pub fn new_names_with_suffix(suffix: String) -> RootNames {
  ...
  RootNames(
    registry: process.new_name("saar_registry_" <> unique),
