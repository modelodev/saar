...
//// - Delegate parsing/rendering to `saar/docs/limits_table`.
//// - Write the generated Markdown file.
////
//// Non-responsibilities:
//// - Defining the limits schema or formatting rules (owned by `saar/docs/limits_table`).
//// - Providing a stable library API for other runtime code.
////
//// Relationships:
//// - Uses `saar/docs/limits_table` as a pure helper module.

import saar/docs/limits_table
import simplifile
...
///
/// Example:
/// - `gleam run -m saar/docs/limits_md`
pub fn main() {
