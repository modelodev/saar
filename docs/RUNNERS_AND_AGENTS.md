...
Example: `docs/examples/profiles/aider.json` maps `chat` to `aider --message {{helpers.last_user_content}}`.
...
Example: `docs/examples/profiles/lightrag.json` exposes `chat` and `files`.
